...
$block = ( $block !== '' ? $block : 'releases-block1' );
$block_option = '';
switch ($block) {
	case 'releases-block1':
		$block = 'releases-block1';
		$block_option = '4';
		break;
	case 'releases-block2':
		$block = 'releases-block1';
		$block_option = '3';
		break;
	case 'releases-block3':
		$block = 'releases-block1';
		$block_option = '2';
		break;
...
// Filter 
$filter_args = array(
	'filter_atts'       => get_post_meta( $wp_query->post->ID, '_filter_atts_releases', false ), 
