...
if ( ! class_exists( 'RascalsThemePanel_color' ) ) {

	class RascalsThemePanel_color extends RascalsThemePanel {
			...
			if ( isset( self::$_option['dependency']) && is_array( self::$_option['dependency'] ) ) {
				...
				echo '<div class="box-row-input">';
					...
					echo '<div class="box-tc box-tc-input">';
						...
						// Field
						// ---------------------------------------
						echo '<input name="' . esc_attr( self::$_option['id'] ) . '" id="' . esc_attr( self::$_option['id'] ) . '" type="text" value="' . esc_attr( self::$_option['std'] ) . '" class="colorpicker-input"/>';
