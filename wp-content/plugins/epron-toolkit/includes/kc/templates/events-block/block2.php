...
// Module Opts 
$module_opts = array(
    'module' => 'epron_event_module2',
    'thumb_size' => 'large',
    'classes' => implode( ' ', $classes )
);

?>
<div data-module-opts='<?php echo json_encode( $module_opts ) ?>' class="ajax-grid flex-grid <?php echo esc_attr( $grid_classes ) ?> flex-gap-medium  posts-container anim-grid kc-events-block1" data-anim-effect="amun">
...
?>
    ...
    <div class="flex-item">
        <?php
            echo epron_event_module2( $module_args ); 
        ?>
    </div>
