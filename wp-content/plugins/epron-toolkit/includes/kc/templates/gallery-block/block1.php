...
// Module Opts 
$module_opts = array(
    'module' => 'epron_gallery_module1',
    'thumb_size' => $thumb_size ,
    'classes' => implode( ' ', $classes )
);

?>
<div data-module-opts='<?php echo json_encode( $module_opts ) ?>' class="ajax-grid flex-grid <?php echo esc_attr( $grid_classes ) ?> flex-gap-medium posts-container anim-grid kc-gallery-block1" data-anim-effect="amun">
...
?>
    ...
    <div class="flex-item">
        <?php
            echo epron_gallery_module1( $module_args ); 
        ?>
    </div>
