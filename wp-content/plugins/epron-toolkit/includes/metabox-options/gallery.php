...
/* ==================================================
  Metaboxes options
================================================== */
function epron_toolkit_mb_gallery() {
	...
	$meta_options = array(
		...
		/* TAB: IMAGES
		 -------------------------------- */
		array(
			'name' => esc_html__( 'Images', 'epron-toolkit' ),
			'id'   => 'tab-images',
			'type' => 'tab_open',
		),
			...
			/* Block */
			array(
				'name'   => esc_html__( 'Images Layout', 'epron-toolkit' ),
				'id'     => '_images_layout',
				'type'   => 'select_image',
				'std'    => 'block1',
				'images' => array(
				...
				'desc' => esc_html__( 'Select images layout for this page.', 'epron-toolkit' )
			),
			...
			array( 
				...
				'buttons'    => array(
					array(
						...
						'label' => esc_html__( 'Add Images', 'epron-toolkit'),
						'title' => esc_html__( 'Add images from media libary', 'epron-toolkit'),
						'color' => 'blue'
					),
				),
				'msg_text' => esc_html__( 'Currently you don\'t have any images, you can add them by clicking on the button below.', 'epron-toolkit'),
	...
	/* Meta info */ 
	$meta_info = array(
		'title' => esc_html__( 'Gallery Options', 'epron-toolkit'), 
...
return epron_toolkit_mb_gallery();